...
<template>
    <div
        class="min-h-screen bg-black text-white font-sans overflow-x-hidden scroll-smooth selection:bg-white selection:text-black">
        ...
        <main class="pt-35 pb-20 px-4 sm:px-6 lg:px-10 max-w-[1600px] mx-auto">
            <slot />
        </main>

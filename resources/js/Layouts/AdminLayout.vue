                            ...
                            <template #trigger>
                                <button
                                    ...
                                    <span v-if="unreadCount > 0"
                                        class="absolute top-2.5 right-2.5 w-1.5 h-1.5 bg-admin-modern rounded-full ring-2 ring-admin-main text-primary shadow-[0_0_10px_rgba(229,255,69,0.5)]"></span>
                                </button>
                            </template>
                            <template #content>
                                <div
                                    ...
                                    <Link :href="route('admin.orders.index')"
                                        class="block p-5 text-center text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 hover:text-admin-modern hover:bg-white/[0.02] transition-all border-t border-white/5">
                                        View System Logs
                                    </Link>
                                </div>
                            </template>

...
<template>
    <Transition enter-active-class="transition ease-out duration-300" enter-from-class="opacity-0"
        enter-to-class="opacity-100" leave-active-class="transition ease-in duration-500" leave-from-class="opacity-100"
        ...
        <div v-if="show" class="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-black">
            ...
            <div class="w-64 h-[2px] bg-zinc-900 rounded-full overflow-hidden relative">
                <div class="absolute inset-y-0 left-0 bg-white transition-all duration-300 ease-out shadow-[0_0_15px_rgba(255,255,255,0.8)]"

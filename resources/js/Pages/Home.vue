...
import DatasetSampleModal from '@/Pages/Home/Partials/DatasetSampleModal.vue'
...
<template>
  ...
  <Head title="End-to-end Data Solutions">
    ...
    <component :is="'script'" type="application/ld+json">
      ...
      "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our primary focus is on South African legal and labour data. We currently provide comprehensive,
      structured datasets from the CCMA and Labour Courts, with Bargaining Council resolutions and High Court judgments
      on our roadmap."
      }
      },
      {
      ...
      "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes. We apply rigorous sanitization, anonymization, and data cleaning processes to our ingestion
      pipelines, ensuring that all structured legal datasets fully comply with the Protection of Personal Information
      Act (POPIA)."
      }
      },
      {
      ...
      "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our data pipelines run continuously. As soon as new judgments or arbitration awards are published on
      public portals, they are extracted, cleaned, and immediately made available through our Developer API and Pro
      Dashboard."
      }
      },
      {
      ...
      "acceptedAnswer": {
      "@type": "Answer",
      "text": "Not at all. While we offer a powerful Developer API for custom integrations, our Pro Dashboard provides a
      complete no-code solution for HR and legal professionals to visually analyze trends and export data to CSV or
      Excel."
      }
      },
      {
      ...
      "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely. Through our Managed Data Pipeline tier, we design and build bespoke web scraping, data
  ...
  <div class="home-page-container">
    ...
    <main>
      <HeroSection :roadmap-items="roadmapItems" @open-modal="isSampleModalOpen = true" />
    ...
    <DatasetSampleModal :show="isSampleModalOpen" :datasets="datasets" @close="isSampleModalOpen = false" />
  </div>
</template>

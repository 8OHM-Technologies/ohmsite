    ...
    <AdminLayout>
        <div class="space-y-10">
            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <main class="flex-1">
                    <div
                        class="bg-zinc-900/40 backdrop-blur-md border border-white/5 p-8 sm:p-12 rounded-[3rem] shadow-2xl relative overflow-hidden">

                        <!-- Profile Settings -->
                        <div v-if="activeTab === 'profile'"
                            class="space-y-12 animate-in slide-in-from-right-4 duration-500">
                            <div class="flex items-center gap-8">
                                <div class="relative group">
                                    ...
                                    <button
                                        class="absolute -bottom-2 -right-2 p-2 bg-white text-black rounded-xl shadow-xl hover:scale-110 transition-all">
                                ...
                                <div>
                                    ...
                                    <p class="text-zinc-500 font-bold uppercase tracking-widest text-[10px] mt-1">{{
                                        user.email }}</p>
                                    <span
                                        class="inline-block bg-admin-modern/10 text-admin-modern border border-admin-modern/20 px-3 py-1 rounded-lg text-[8px] font-black uppercase tracking-widest mt-4">Administrative
                                        Access</span>
                                </div>
                            </div>
                            ...
                            <form @submit.prevent="updateProfile" class="space-y-8">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div class="space-y-3">
                                        <label
                                            class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-1">Email
                                            Address</label>
                                    ...
                                    <div class="space-y-3">
                                        <label
                                            class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-1 flex items-center gap-2">
                                            <Globe class="w-3 h-3" /> Preferred Language
                                        </label>
                                        <select v-model="profileForm.language"
                                            class="w-full bg-black/40 border-white/5 rounded-2xl py-4 px-6 text-white focus:ring-1 focus:ring-admin-modern/40 transition-all font-bold uppercase tracking-widest text-[10px]">
                        ...
                        <div v-if="activeTab === 'security'"
                            ...
                            <div class="flex items-center gap-4 mb-8">
                                ...
                                <h3 class="text-2xl font-black text-white uppercase tracking-tighter leading-none">
                            ...
                            <form @submit.prevent="updatePassword" class="space-y-8">
                                <div class="max-w-xl space-y-8">
                                    <div class="space-y-3">
                                        <label
                                            class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-1">Current
                                            Password</label>
                                        <input type="password" v-model="securityForm.current_password"
                                            class="w-full bg-black/40 border-white/5 rounded-2xl py-4 px-6 text-white focus:ring-1 focus:ring-admin-modern/40 transition-all" />
                                    </div>
                                    <div class="space-y-3">
                                        <label
                                            class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-1">New
                                            Secret Key</label>
                                    ...
                                    <div class="space-y-3">
                                        <label
                                            class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-1">Confirm
                                            New Key</label>
                        ...
                        <div v-if="activeTab === 'store'"
                            ...
                            <form @submit.prevent="updateStore" class="space-y-8">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div class="space-y-3">
                                        <label
                                            class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-1">Global
                                            Currency</label>

        ...
        <div class="flex flex-col sm:flex-row sm:items-end justify-between mb-8 lg:mb-12 gap-6">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h1 class="text-3xl sm:text-4xl font-black uppercase tracking-tighter text-white">Datasets
                        Configuration</h1>
                </div>
                <div>
                    <p class="text-zinc-500 font-bold uppercase tracking-widest text-[10px]">Configure legal case law and
                    metadata sources</p>
                </div>
            </div>
            ...
            <div class="p-4 sm:p-8">
                            ...
                            <tr v-for="dataset in datasets" :key="dataset.id" class="group">
                                <td
                                    ...
                                    <div class="flex items-center gap-5">
                                        <div
                                            class="w-12 h-12 rounded-xl bg-zinc-900 border border-white/5 flex items-center justify-center overflow-hidden shrink-0">
                                        ...
                                        <div>
                                            ...
                                            <p
                                                class="text-[9px] font-bold text-zinc-600 uppercase tracking-widest truncate max-w-md">
                                ...
                                <td
                                    ...
                                    <span
                                        class="text-xs font-mono text-zinc-300 bg-zinc-950 px-3 py-1.5 rounded-lg border border-white/5">
                                        {{ dataset.slug }}
                                    </span>
                                </td>
                                <td
                                    ...
                                    <div class="flex items-center gap-2">
                                        <component :is="dataset.is_active ? CheckCircle : XCircle" class="w-4 h-4"
                ...
                <div class="lg:hidden space-y-4">
                    <div v-for="dataset in datasets" :key="dataset.id"
                        ...
                        <div class="flex items-center gap-5">
                            <div
                                class="w-14 h-14 rounded-2xl bg-zinc-900 border border-white/5 flex items-center justify-center overflow-hidden shrink-0">
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
                            <div class="flex flex-col gap-1">
                                <span
                                    class="text-[8px] font-black text-zinc-500 uppercase tracking-widest">Status</span>
                ...
                <div v-if="datasets.length === 0" class="py-32 text-center flex flex-col items-center">
                    ...
                    <h3 class="text-2xl font-black uppercase tracking-tighter text-zinc-700 mb-2">No datasets configured
                    </h3>
                    <p class="text-zinc-600 font-bold uppercase tracking-widest text-[10px]">Start by creating your
                        first case law or telemetry dataset</p>
                </div>
            </div>
        </div>
    </AdminLayout>

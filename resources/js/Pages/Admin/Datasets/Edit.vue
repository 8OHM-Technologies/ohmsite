...
const form = useForm({
    ...
    is_active: props.dataset.is_active,
    demo_data: props.dataset.demo_data ? JSON.stringify(props.dataset.demo_data, null, 4) : ''
});
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            <InputLabel for="demo_data" value="Demo JSON Data"
                                class="text-zinc-600 font-black uppercase tracking-widest text-[10px] mb-3 ml-1" />
                            <textarea id="demo_data" v-model="form.demo_data" rows="12" placeholder='[{}]'
                            ...
                            <div v-if="jsonError"
                                class="text-rose-500 text-[10px] font-black uppercase tracking-wider mt-2 ml-1">
                                {{ jsonError }}
                            </div>

    ...
    <AdminLayout>
        <div class="space-y-8 animate-in fade-in duration-700">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 class="text-3xl font-black text-white tracking-tight uppercase">Licenses <span class="text-admin-modern">Manager</span></h1>
                    <p class="text-zinc-500 mt-1 font-medium">Monitor active subscriptions, dataset accesses, and platforms licenses.</p>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="border-b border-white/5">
                                <th class="px-8 py-6 text-[10px] font-black text-zinc-500 uppercase tracking-widest">Service Details</th>
                                <th class="px-8 py-6 text-[10px] font-black text-zinc-500 uppercase tracking-widest">Classification</th>
                                <th class="px-8 py-6 text-[10px] font-black text-zinc-500 uppercase tracking-widest text-right">Price</th>
                                <th class="px-8 py-6 text-[10px] font-black text-zinc-500 uppercase tracking-widest">Fulfillment Type</th>
                        ...
                        <tbody class="divide-y divide-white/5">
                            <tr v-for="product in products.data" :key="product.id" class="group hover:bg-white/[0.02] transition-colors">
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[10px] font-black text-zinc-500 uppercase tracking-widest mt-1">SKU: 8OHM-{{ 1000 + product.id }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-8 py-6">
                                ...
                                <td class="px-8 py-6">
                                    <span class="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider border bg-green-400/10 text-green-400 border-green-400/20">
                                        Unlimited SaaS
                                    </span>
                                </td>

        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start pb-20">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-zinc-900/40 rounded-[2.5rem] border border-white/5 p-6 sm:p-10">
                    ...
                    <div class="space-y-8">
                        <div>
                            <InputLabel for="name" value="Product Title"
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="relative">
                                    <input id="price" type="number" step="0.01" v-model="form.price"
                                        class="w-full bg-black/40 border border-white/5 text-white rounded-xl py-4 px-6 font-black text-lg"
                                        required />
                                </div>
                            </div>
                            <div class="sm:col-span-1">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-black border border-white/5 rounded-[2.5rem] p-6 sm:p-10 shadow-2xl">
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <div class="relative group aspect-square">
                                <input type="file" id="image" @change="handleMainImage"
                                    ...
                                    accept="image/*" />
                                <div
                                    class="h-full bg-zinc-900 border-2 border-dashed border-white/5 rounded-[2rem] flex flex-col items-center justify-center text-center p-6 transition-all group-hover:border-admin-modern group-hover:bg-zinc-900/50">
                                    <Upload
                                        class="w-10 h-10 text-zinc-700 mb-4 group-hover:text-admin-modern transition-colors" />
                                    <p class="text-[10px] font-black uppercase tracking-widest text-zinc-600">Drag
                                        primary image</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <InputLabel value="Studio Gallery (Max 4)"
                                class="text-zinc-600 font-black uppercase tracking-widest text-[10px] mb-4 ml-1" />
                            <div class="relative group">
                                <input type="file" id="gallery" @change="handleGalleryImages" multiple
                                    ...
                                    accept="image/*" />
                                <div
                                    class="bg-zinc-900 border-2 border-dashed border-white/5 rounded-3xl py-10 flex flex-col items-center justify-center text-center px-6 transition-all group-hover:border-white/20">
                                    <Plus class="w-8 h-8 text-zinc-700 mb-2" />
                                    <p class="text-[9px] font-black uppercase tracking-widest text-zinc-700">Multiple
                                        selection</p>
                                </div>
                            </div>
                        </div>

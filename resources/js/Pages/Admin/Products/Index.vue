                                ...
                                <td
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-[10px] font-black uppercase tracking-[0.1em]"
                                            :class="[product.stock > 0 ? 'text-zinc-400' : 'text-rose-500']">
                ...
                <div class="lg:hidden space-y-4">
                    <div v-for="product in products" :key="product.id"
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
                            <div class="flex flex-col gap-1">
                                <span
                                    class="text-[8px] font-black text-zinc-500 uppercase tracking-widest">Availability</span>
                                <div class="flex items-center gap-2">
                                    <div class="w-1.5 h-1.5 rounded-full"
                                        :class="[product.stock > 0 ? 'bg-admin-modern' : 'bg-rose-500']"></div>

        ...
        <div class="w-full lg:w-1/3 flex items-center justify-center p-10 bg-zinc-950 overflow-y-auto h-screen">
            <div class="max-w-md w-full space-y-10 py-10">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label for="first_name"
                                class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-1">First Name</label>
                            <div class="relative">
                            ...
                            <p v-if="form.errors.first_name"
                                class="text-red-500 text-[10px] font-black uppercase tracking-widest mt-1 ml-1">{{
                                    form.errors.first_name }}</p>
                        </div>

                        <div class="space-y-2">
                            <label for="last_name"
                                class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-1">Last Name</label>
                            <div class="relative">
                                <span class="absolute left-5 top-1/2 -translate-y-1/2 text-zinc-600">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <!-- Company Name (Optional) & Phone -->
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label for="company_name"
                                class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-1">Company Name</label>
                            <div class="relative">
                                <span class="absolute left-5 top-1/2 -translate-y-1/2 text-zinc-600">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <input id="company_name" type="text" v-model="form.company_name" placeholder="Company Name (Optional)"
                                    class="w-full bg-zinc-900/50 border border-white/5 rounded-2xl py-4 pl-14 pr-6 text-sm font-bold focus:ring-1 focus:ring-white/20 focus:border-white/20 transition-all placeholder:text-zinc-700"
                                    autocomplete="organization" />
                            </div>
                            <p v-if="form.errors.company_name"
                                class="text-red-500 text-[10px] font-black uppercase tracking-widest mt-1 ml-1">{{
                        ...
                        <div class="space-y-2">
                            <label for="phone"
                                class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-1">Phone</label>
                            <div class="relative">
                                <span class="absolute left-5 top-1/2 -translate-y-1/2 text-zinc-600">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <input id="phone" type="text" v-model="form.phone" placeholder="Phone"
                                    class="w-full bg-zinc-900/50 border border-white/5 rounded-2xl py-4 pl-14 pr-6 text-sm font-bold focus:ring-1 focus:ring-white/20 focus:border-white/20 transition-all placeholder:text-zinc-700"
                    ...
                    <div class="space-y-2">
                        <label for="country"
                            class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-1">Country</label>
                        <div class="relative">
                            <span class="absolute left-5 top-1/2 -translate-y-1/2 text-zinc-600">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p v-if="form.errors.country"
                            class="text-red-500 text-[10px] font-black uppercase tracking-widest mt-1 ml-1">{{
                                form.errors.country }}</p>
                    </div>

                    <!-- Email -->
                    <div class="space-y-2">
                        <label for="email"
                            class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-1">Email
                            Address</label>
                        <div class="relative">
                            <span class="absolute left-5 top-1/2 -translate-y-1/2 text-zinc-600">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-2">
                        <label for="password"
                            class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-1">Password</label>
                        <div class="relative">
                            <span class="absolute left-5 top-1/2 -translate-y-1/2 text-zinc-600">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <button type="button" @click="showPassword = !showPassword"
                                ...
                                <svg v-else class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.05 10.05 0 012.13-3.501m3.187-3.187A9.956 9.956 0 0112 5c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21m-2.101-2.101L3 3" />
                                </svg>
                            </button>
                        </div>
                    ...
                    <div class="space-y-2">
                        <label for="password_confirmation"
                            class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-1">Confirm
                            Password</label>
                        <div class="relative">
                            <span class="absolute left-5 top-1/2 -translate-y-1/2 text-zinc-600">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

        ...
        <div class="hidden lg:flex lg:w-2/3 relative">
            ...
            <div class="relative z-10 p-20 flex flex-col justify-between w-full h-full">
                ...
                <Link :href="route('home')">
                    <img src="/assets/images/8OHM_Logo_border.webp" alt="Logo" class="h-12" />
                </Link>
                <div class="h-10"></div>
            ...
            <div class="max-w-md w-full space-y-10 py-10">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between items-center ml-1">
                            <label for="password"
                                class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500">Password</label>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="remember" v-model="form.remember"
                            class="w-4 h-4 bg-zinc-900 border-white/10 rounded focus:ring-0 text-white" />
                        <label for="remember"
                            class="text-[10px] font-black uppercase tracking-widest text-zinc-500 ml-3 cursor-pointer">Remember
                            me</label>
                    </div>
                ...
                <div class="pt-4">
                    <p class="text-center text-[10px] font-black uppercase tracking-widest text-zinc-600">
                        ...
                        <Link :href="route('register')" class="text-white hover:underline transition-all">Register
                        </Link>
                    </p>
                </div>
            </div>

    ...
    <div
        ...
        <div class="w-full max-w-md">
            <div
                ...
                <!-- Decorative Elements -->
                <div
                    class="absolute -bottom-24 -left-24 w-48 h-48 bg-white opacity-[0.02] blur-[80px] group-hover:opacity-[0.05] transition-opacity duration-1000">
                </div>

                <!-- Header -->
                <div class="mb-10 relative z-10 text-center">
                    <div
                        class="w-16 h-16 bg-zinc-900 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-white/5 shadow-xl group-hover:border-admin-modern/30 transition-all duration-700">
                        <KeyRound class="w-8 h-8 text-admin-modern" />
                    </div>
                    <h1 class="text-3xl font-black uppercase tracking-tighter leading-none mb-4">Reset
                        Authentication</h1>
                ...
                <form @submit.prevent="submit" class="space-y-8 relative z-10">
                    ...
                    <div class="space-y-3 opacity-60">
                        <label class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-1">Account
                            Identity</label>
                        <div class="relative">
                    ...
                    <div class="space-y-3">
                        <label for="password"
                            class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-1">New Secret
                            Key</label>
                        ...
                        <p v-if="form.errors.password"
                            class="text-[10px] font-black text-rose-500 uppercase tracking-widest ml-1">{{
                    ...
                    <div class="space-y-3">
                        <label for="password_confirmation"
                            class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-1">Verify
                            Key</label>
                        <div class="relative group">
                            <ShieldAlert
                                class="absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-600 group-focus-within:text-white transition-colors" />

    ...
    <MainLayout :auth="auth" title="My Wishlist">
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col sm:flex-row sm:items-end justify-between mb-16 gap-6">
                <div>
                    <h1 class="text-7xl font-black uppercase tracking-tighter text-white leading-none">My Wishlist</h1>
            ...
            <div v-if="favorites.length === 0"
                class="bg-zinc-900/50 rounded-[3rem] border border-dashed border-white/5 p-24 text-center">
                    ...
                    <Link :href="route('shop.show', product.id)" class="block">
                        <div
                            ...
                            <img :src="product.image" :alt="product.name"
                                class="h-44 object-contain relative z-10 transition-all duration-1000 group-hover:scale-110 group-hover:-rotate-12 drop-shadow-[0_20px_20px_rgba(0,0,0,0.5)]" />
                        </div>
